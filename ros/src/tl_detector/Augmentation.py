...
##how does it work?
#path='./Augmentation/test_augmentation/image1.jpg'
#images=load_images(path)
#image1=brighten(images[-1])
#image2=darken(images[-1])
#image3=add_shadow(images[-1])
#image4=add_rain(images[-1])
#image5=add_fog(images[-1])
#image6=add_gravel(images[-1])
#image7=add_sun_flare(images[-1])
#plt.imshow(image7)
